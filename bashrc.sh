alias net-info='nmcli dev list iface wlan0 | grep IP4'

## HISTORY CONTROL ########################################################
# I added the next lines because Linux Mint didn't have history
# enabled by default
...
###########################################################################
# Write nice banner with calendar and uptime
